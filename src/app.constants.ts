export const TIME_PERIODS: {id: string, label: string}[] = [
    {
        id: 'daily',
        label: 'Daily'
    },
...
export const LANGUAGES: {id: string, label: string}[] = [
  ...
  {
    "id": "debian-package-control-file",
  ...
  {
    "id": "microsoft-developer-studio-project",
    "label": "Microsoft Developer Studio Project"
  },
  {
    "id": "microsoft-visual-studio-solution",
  ...
  {
    "id": "object-data-instance-notation",
  ...
  {
    "id": "protocol-buffer-text-format",
